...
var PublishCommentRequest_VideoID_DEFAULT int64

func (p *PublishCommentRequest) GetVideoID() (v int64) {
	if !p.IsSetVideoID() {
...
var PublishCommentRequest_CommentID_DEFAULT int64

func (p *PublishCommentRequest) GetCommentID() (v int64) {
	if !p.IsSetCommentID() {

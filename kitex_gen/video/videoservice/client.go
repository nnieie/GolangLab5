...
type Client interface {
	...
	BatchUpdateVideoLikeCount(ctx context.Context, req *video.BatchUpdateVideoLikeCountRequest, callOptions ...callopt.Option) (r *video.BatchUpdateVideoLikeCountResponse, err error)
}
...
func (p *kVideoServiceClient) BatchUpdateVideoLikeCount(ctx context.Context, req *video.BatchUpdateVideoLikeCountRequest, callOptions ...callopt.Option) (r *video.BatchUpdateVideoLikeCountResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.BatchUpdateVideoLikeCount(ctx, req)
}

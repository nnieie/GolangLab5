...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"BatchUpdateVideoLikeCount": kitex.NewMethodInfo(
		batchUpdateVideoLikeCountHandler,
		newVideoServiceBatchUpdateVideoLikeCountArgs,
		newVideoServiceBatchUpdateVideoLikeCountResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
func batchUpdateVideoLikeCountHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*video.VideoServiceBatchUpdateVideoLikeCountArgs)
	realResult := result.(*video.VideoServiceBatchUpdateVideoLikeCountResult)
	success, err := handler.(video.VideoService).BatchUpdateVideoLikeCount(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceBatchUpdateVideoLikeCountArgs() interface{} {
	return video.NewVideoServiceBatchUpdateVideoLikeCountArgs()
}

func newVideoServiceBatchUpdateVideoLikeCountResult() interface{} {
	return video.NewVideoServiceBatchUpdateVideoLikeCountResult()
}
...
func (p *kClient) BatchUpdateVideoLikeCount(ctx context.Context, req *video.BatchUpdateVideoLikeCountRequest) (r *video.BatchUpdateVideoLikeCountResponse, err error) {
	var _args video.VideoServiceBatchUpdateVideoLikeCountArgs
	_args.Req = req
	var _result video.VideoServiceBatchUpdateVideoLikeCountResult
	if err = p.c.Call(ctx, "BatchUpdateVideoLikeCount", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
